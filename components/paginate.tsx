...
const Paginate = ({ total, current }: { total: number; current: number }) => {
  ...
  return (
    <Pagination className="my-12">
      <PaginationContent>
        {current !== 1 && <PaginationPrevious href={createQueryString("page", current - 1)}></PaginationPrevious>}
        ...
        {current !== lastPage && <PaginationNext href={createQueryString("page", current + 1)}></PaginationNext>}
      </PaginationContent>
    </Pagination>
  )
}
